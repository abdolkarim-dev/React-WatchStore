function Header() {
  return ( <header
    ...
    >
      {/* <!-- backdrop-blur-xl --> */}
      <div
        className="relative mx-auto flex-row-reverse flex md:flex-row h-20 max-w-7xl items-center justify-between px-6 lg:px-8"
      >
        <a href="#" className="text-2xl font-semibold tracking-tight md:hidden">
        ...
        <nav
          id="mobileMenuNav"
          className="absolute left-0 top-20 z-50 flex h-[calc(100vh-5rem)] w-[78vw] max-w-sm -translate-x-full flex-col justify-between overflow-hidden rounded-r-3xl border-r border-black/5 bg-[#f7f7f5] p-6 transition-transform duration-500 ease-out backdrop-blur-xl md:hidden"
        >
          {/* <!-- Top --> */}
          <div>
            {/* <!-- Menu label --> */}
            <div className="mb-10 flex items-center justify-between">
                {/* <div>
                <p
                  className="text-[10px] uppercase tracking-[0.3em] text-[#8b7355]"
                >
                  Navigation
                </p>

                <h2 className="mt-1 text-lg font-medium">Explore</h2>
              </div>   */}
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-4">
                   {/* <span className="text-[10px] text-black/30"> 03 </span>  */}

                  <span className="text-sm font-medium"> Collections </span>
                </div>

                  {/* <span
                  className="text-black/20 transition group-hover:translate-x-1"
                >
                  →
                </span>   */}
              </a>
          ...
          <div>
            ...
            >
              <div
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#eeeae3]"
              >
                <svg
            ...
            >
              <div className="relative">
                ...
                <span
                  className="absolute -right-2 -top-2 flex h-4 w-4 items-center justify-center rounded-full bg-[#171717] text-[8px] text-white"
                >
                  2
                </span>
              </div>
            ...
            {/* <!-- Small brand text --> */}
            <p
              className="mt-6 text-center text-[9px] uppercase tracking-[0.3em] text-black/25"
            >
        ...
        <div className="flex items-center gap-5">
          {/* <!-- Mobile menu --> */}
          <button id="mobileMenuBtn" className="md:hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
          ...
          <button className="relative hidden md:block">
            ...
            <span 
              className="absolute -right-2 -top-2 flex h-4 w-4 items-center justify-center rounded-full bg-[#171717] text-[9px] text-white"
            >
              2
            </span>
          </button>
          ...
          <button className="hidden md:block">
            ...
            >
              <circle cx="12" cy="8" r="3.5" />
              <path stroke-linecap="round" d="M5 21c.7-4 3-6 7-6s6.3 2 7 6" />
            </svg>
          </button>
        </div>
      </div>
